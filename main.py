...
from functions import TARGET_TERM_LABEL, add_course_db, enroll_student_db
...
def run_cli():
    while True:
        ...
        print(f"Target term: {TARGET_TERM_LABEL}")
        ...
        if choice == "1":
            ...
            print(enroll_student_db(roll_no, course_ids))
        elif choice == "3":
            break
        else:
